class ProjectIdeasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project_idea.save
        ...
        format.json { render :show, status: :created, location: @project_idea }
      else
  ...
  def update
    respond_to do |format|
      if @project_idea.update(project_idea_params)
        ...
        format.json { render :show, status: :ok, location: @project_idea }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_ideas_url, notice: 'Project idea was successfully destroyed.' }
  ...
  private
    ...
    def project_idea_params
      params.require(:project_idea).permit(:project_title, :project_details)
    end
end
