...
class ProjectIdeasControllerTest < ActionController::TestCase
  ...
  test "should create project_idea" do
    assert_difference('ProjectIdea.count') do
      post :create, project_idea: { project_details: @project_idea.project_details, project_title: @project_idea.project_title }
    end
  ...
  test "should update project_idea" do
    patch :update, id: @project_idea, project_idea: { project_details: @project_idea.project_details, project_title: @project_idea.project_title }
    assert_redirected_to project_idea_path(assigns(:project_idea))
  end
